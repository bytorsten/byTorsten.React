...
class Process extends AbstractProcess
{
     ...
     */
    public function __construct(string $script, array $parameter = [])
    {
        $this->cmd = 'exec ' . $script . ' ' . implode(' ', array_map(function ($value, $name) {
    ...
    public function start(LoopInterface $loop): void
    {
        ...
        $cmd = $this->cmd . ' 2>' . $this->pipeNames['stderr'] . ' >' . $this->pipeNames['stdout'];
